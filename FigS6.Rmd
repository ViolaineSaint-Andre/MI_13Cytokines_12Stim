...
#df.dataProtEcoli <- df.dataProt
#df.dataProtEcoli$StimulusName <- "E.coli"

#df.dataProtSEB <- df.dataProt
#df.dataProtSEB$StimulusName <- "SEB"

#df.dataProtCD3CD28 <- df.dataProt
#df.dataProtCD3CD28$StimulusName <- "CD3+CD28"

#df.dataProtLPS <- df.dataProt
#df.dataProtLPS$StimulusName <- "LPS"

#df.dataProtBCG <- df.dataProt
#df.dataProtBCG$StimulusName <- "BCG"


#df.dataProtbind <- rbind(df.dataProtEcoli,df.dataProtSEB, df.dataProtCD3CD28, df.dataProtLPS, df.dataProtBCG)
...
crit='TABAC.T1'  
   ...
   protein="IL2" 
    p <- ggplot(data=df.dataProtbind %>% filter(Cytokine==protein), 
                ...
                ylim(-2.5,3)+ # pour residus CXCL5
                ylim(-2.5,2.5)+ # pour residus IL2
                theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
                scale_fill_viridis_d() +
                ggtitle(paste0('Crit = ', crit, ' Prot = ', protein))
                
    # save as PDF
    ggsave(plot=p, filename = paste0(pathRes,'/plotResiduals_', protein,'_',crit,'_',Sys.Date(), '_fix2.5_2.5_y.pdf'), width = 7, height=7)
