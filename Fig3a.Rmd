...
crit="TABAC.T1"  
  ...
  ggsave(plot=marrangeGrob(grobs=heatmapList, nrow=1, ncol=1), filename = paste0(pathRes, '/Heatmap_SmokingvsCells_', stimul, Sys.Date(), '.pdf'), width= 8.5, height=11)
  
   write.table(as.data.frame(melted_matDATA_ordered),file=paste0(pathRes,"/HeatmapsSmokingvsCells_values_", stimul,"_", Sys.Date(),".txt"), quote=F, row.names = F, col.names = T, sep="\t")
...
#save.image(file=paste0('./SmokingVsCells_', Sys.Date(), '.RData'))
````
